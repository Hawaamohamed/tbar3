...
<div class="login-box">
    ...
    <div class="login-box-body">
        ...
        <form action="<?php if ($type=='charity') echo url('reset/password/final/'.$data->token);
        elseif ($type=='donor') echo url('reset/password/donor/final/'.$data->token);?>" method="post">
            {{csrf_field()}}
            ...
            <div class="row">
                ...
                <!-- /.col -->
                <div class="col-xs-4">
                    <button style="background: #2d958b;color:white" type="submit" class="btn btn-primary btn-block btn-flat">حفظ</button>
                </div>
                <!-- /.col -->
            </div>
        </form>
